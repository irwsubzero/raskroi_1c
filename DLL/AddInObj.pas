...
type
  ...
  protected
    ...
    //vk_object: T_vk_object;
     FMaterial:Widestring;  // Если использовать string то утечки памяти при передаче значений свойствам
     FOriginalWidth,FOriginalHeight:double;
     FPieces:array of array [0..3] of Widestring; // массив где будет храниться переданные через свойство данные
